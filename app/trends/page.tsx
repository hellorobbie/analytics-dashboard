...
export default function TrendsPage() {
  ...
  const calculateStats = () => {
    if (trends.length === 0) {
      return { totalConversions: 0, totalRevenue: 0, avgConversionRate: 0, totalSessions: 0 };
    }
    ...
    const avgConversionRate = trends.reduce((sum, t) => sum + t.conversion_rate, 0) / trends.length;
